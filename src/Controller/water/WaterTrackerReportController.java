/*********************************************************
 *
 *                   WaterTrackerReportController.java (Controller)
 *
 *
 **********************************************************/
...
public class WaterTrackerReportController {
    ...
    /*
     *
     * Description: This method displays report data on a graph based on selected dates.
     * Param: void
     * Returns: void
     *
     */
    @FXML public void getReport(){
        ...
        if(sDate == null || eDate == null){
            ...
            if (verifyDates(sDate, eDate)) {
                ...
                ArrayList<Integer> report = user.getWaterTracker().generateReport(sDate, eDate);

                bc.setTitle("WaterTracker report");

                bc.setLegendVisible(false);
                yAxis.setLabel("Amount Drank (ml)");
    ...
    /*
     *
     * Description: This method clears the current chart information
     * Param: void
     * Returns: void
     *
     */
    ...
    /*
     *
     * Description: This method verfies start date is after end date
